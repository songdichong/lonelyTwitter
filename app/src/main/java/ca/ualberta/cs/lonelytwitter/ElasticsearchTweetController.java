...
public class ElasticsearchTweetController {
    ...
    // static: only allow this function once and not created dynamically
    public static class AddTweetsTask extends AsyncTask<NormalTweet, Void, Void> {

        //...: java syntax, allow you put things later
        @Override
            ...
            try {
               // TODO get the results of the query
                ...
                if (result.isSucceeded()){
                    ...
                    Log.i("Error","Something went wrong when we tried to communicate with server");
                }
            }
            catch (Exception e) {
